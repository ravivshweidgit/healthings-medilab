...
bulk('withings-scale', [
  ['en', 'Withings body scale', 'Any Withings scale on your account works. Healthings reads the cloud after you link — not Bluetooth.', `<p>Body Comp, Body Smart, Body Scan, and similar models all work.</p><p>For Healthings we usually recommend <strong>Body Comp</strong> — weight, muscle, fat, and BMR sync to the body card. <strong>Body Scan 2</strong> works too; segmental zones, ECG, and other premium metrics stay in the Withings app only.</p>`],
  ['he', 'משקל Withings', 'כל משקל Withings בחשבון מתאים. אחרי החיבור קוראים מהענן, לא מ־Bluetooth.', `<p>Body Comp, Body Smart, Body Scan ודומיהם — כולם מתאימים.</p><p>ל־Healthings בדרך כלל מספיק <strong>Body Comp</strong> — משקל, שריר, שומן ו־BMR נסנכרנים לכרטיס הגוף. <strong>Body Scan 2</strong> גם עובד; מדידות סגמנט ו־ECG נשארות באפליקציית Withings בלבד.</p><p>חיבור אחד מכסה גם שעון, אם יש.</p>`],
  ['es', 'Báscula Withings', 'Cualquier báscula Withings de tu cuenta sirve. Tras vincular, se lee la nube — no Bluetooth.', `<p>Body Comp, Body Smart, Body Scan y similares funcionan.</p><p>Para Healthings suele bastar <strong>Body Comp</strong> — peso, músculo, grasa y BMR en la tarjeta corporal. <strong>Body Scan 2</strong> también vale; segmentación y ECG solo en la app Withings.</p>`],
  ['fr', 'Balance Withings', 'Toute balance Withings du compte convient. Après liaison, lecture cloud — pas Bluetooth.', `<p>Body Comp, Body Smart, Body Scan et similaires conviennent.</p><p>Pour Healthings, <strong>Body Comp</strong> suffit en général — poids, muscle, graisse et BMR sur la carte corps. <strong>Body Scan 2</strong> aussi ; segmentaire et ECG restent dans l’app Withings.</p>`],
  ['de', 'Withings-Körperwaage', 'Jede Withings-Waage im Konto passt. Nach dem Link liest die App die Cloud — nicht Bluetooth.', `<p>Body Comp, Body Smart, Body Scan und ähnliche passen.</p><p>Für Healthings reicht meist <strong>Body Comp</strong> — Gewicht, Muskel, Fett und BMR auf der Körperkarte. <strong>Body Scan 2</strong> auch — Segment- und ECG-Daten bleiben in der Withings-App.</p>`],
  ['ar', 'ميزان Withings', 'أي ميزان Withings في حسابك يناسب. بعد الربط نقرأ من السحابة — وليس Bluetooth.', `<p>Body Comp و Body Smart و Body Scan وما شابه — كلها مناسبة.</p><p>لـ Healthings يكفي عادةً <strong>Body Comp</strong> — الوزن والعضل والدهون و BMR على بطاقة الجسم. <strong>Body Scan 2</strong> يعمل أيضاً؛ قياسات الأجزاء و ECG تبقى في تطبيق Withings فقط.</p>`],
  ['ru', 'Весы Withings', 'Подойдут любые весы Withings в аккаунте. После связи данные из облака — не Bluetooth.', `<p>Body Comp, Body Smart, Body Scan и похожие подходят.</p><p>Для Healthings обычно хватает <strong>Body Comp</strong> — вес, мышцы, жир и BMR на карточке тела. <strong>Body Scan 2</strong> тоже работает; сегменты и ECG только в приложении Withings.</p>`],
  ['pt', 'Balança Withings', 'Qualquer balança Withings na conta serve. Após ligar, lê-se a nuvem — não Bluetooth.', `<p>Body Comp, Body Smart, Body Scan e similares servem.</p><p>Para Healthings, <strong>Body Comp</strong> costuma bastar — peso, músculo, gordura e BMR no cartão corporal. <strong>Body Scan 2</strong> também — segmentos e ECG ficam só na app Withings.</p>`],
  ['it', 'Bilancia Withings', 'Qualsiasi bilancia Withings sull’account va bene. Dopo il link legge il cloud — non Bluetooth.', `<p>Body Comp, Body Smart, Body Scan e simili vanno bene.</p><p>Per Healthings di solito basta <strong>Body Comp</strong> — peso, muscolo, grasso e BMR sulla scheda corpo. Anche <strong>Body Scan 2</strong> — segmenti ed ECG restano solo nell’app Withings.</p>`],
  ['tr', 'Withings tartı', 'Hesabınızdaki herhangi bir Withings tartı çalışır. Bağladıktan sonra buluttan okur — Bluetooth değil.', `<p>Body Comp, Body Smart, Body Scan ve benzerleri uygundur.</p><p>Healthings için genelde <strong>Body Comp</strong> yeterli — kilo, kas, yağ ve BMR vücut kartında. <strong>Body Scan 2</strong> de olur; segment ve ECG Withings uygulamasında kalır.</p>`],
]);
