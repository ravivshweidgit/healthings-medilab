...
export const AMOUNT_DEFS = {
  ...
  fresh: { fresh: true },
  quinoaG: { text: '150 g' },
  eggWhole: { text: '2 eggs (~120 g)' },
  toastSlice: { text: '1 slice (~30 g)' },
  appleMedium: { text: '1 medium (~180 g)' },
  cottageG: { text: '100 g' },
  cucumberHalf: { text: '½ (~150 g)' },
  chickenG: { text: '120 g' },
  saladG: { text: '200 g' },
  chickpeas: { tbsp: 3 },
  riceG: { text: '80 g cooked' },
  broccoliG: { text: '150 g' },
  soupMl: { text: '250 ml' },
  yogurtSmall: { text: '100 g' },
  cauliflowerG: { text: '100 g' },
  pastaG: { text: '60 g dry' },
  fishSmall: { text: '80 g' },
  steakG: { text: '150 g' },
  asparagusG: { text: '200 g' },
  cheeseG: { text: '30 g' },
  nutsG: { text: '20 g' },
  cinnamon: { text: '½ tsp' },
  berriesG: { text: '50 g' },
  oatsG: { text: '40 g dry' },
  lentilsCooked: { text: '100 g' },
  greensG: { text: '100 g' },
  eggWhite: { text: '3 whites (~100 g)' },
  breadWhite: { text: '1 slice (~25 g)' },
  jam: { tbsp: 1 },
  zucchiniG: { text: '150 g' },
  butter: { tbsp: 1 },
  oliveSmall: { tbsp: 1 },
  avocadoHalf: { text: '½ (~70 g)' },
  turkeyG: { text: '120 g' },
  shakeMl: { text: '200 ml' },
  vegMixG: { text: '150 g' },
};
...
ui('en', {
  ...
  mealLoggingBlurb:
    '<p><a href="../plates/index.html">Example plates</a> — meals from the log with amounts you can type into Log Meal.</p>',
  inApp: 'In the app',
  textEg: 'text, e.g.',
});
