...
export type FoodItem = {
  ...
  rule_message?: string;
  /** warning = attention; critical = hard ban / allergen-class (prompt108). */
  rule_severity?: 'warning' | 'critical';
};
...
{"items":[{"name":"...","name_local":"...","grams":0,"kcal":0,"protein_g":0.0,"carb_g":0.0,"fat_g":0.0,"fiber_g":0.0,"rule_conflict":false,"rule_severity":"","rule_message":""}],"confidence":"high","description":"...","suggestion":"..."}
