...
const EN: ActivityLogUiCopy = {
  ...
  equipmentWeightHint: 'Optional — total extra mass (both DBs or bar). ACSM: MET × (body+load) × time.',
  kcal: 'kcal',
  aiCalc: 'AI calc',
...
const HE: ActivityLogUiCopy = {
  ...
  equipmentWeightHint: 'אופציונלי — מסת עומס כוללת (שתי משקולות או מוט). ACSM: MET × (גוף+עומס) × זמן.',
  aiCalc: 'חישוב AI',
