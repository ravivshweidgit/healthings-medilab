...
export type FoodLogUiCopy = {
  ...
  logMeal: string;
  editMeal: string;
  /** Items section title in meal editor */
  yourMeal: string;
  /** Shown when opening a saved meal for edit */
  editingSavedMealHint: string;
  /** Meal timestamp row label */
  dateAndTime: string;
  camera: string;
  gallery: string;
...
const EN: FoodLogUiCopy = {
  ...
  editMeal: 'Edit Meal',
  yourMeal: 'Your meal',
  editingSavedMealHint: 'Editing a saved meal — add a photo or use chat to correct.',
...
const HE: FoodLogUiCopy = {
  ...
  yourMeal: 'הארוחה שלכם',
  editingSavedMealHint: 'עורכים ארוחה שמורה — הוסיפו תמונה או תקנו בצ׳אט.',
...
const ES: FoodLogUiCopy = {
  ...
  yourMeal: 'Tu comida',
  editingSavedMealHint: 'Editando una comida guardada — añade una foto o corrige por el chat.',
...
const FR: FoodLogUiCopy = {
  ...
  editingSavedMealHint:
    'Modification d’un repas enregistré — ajoutez une photo ou corrigez via le chat.',
...
const DE: FoodLogUiCopy = {
  ...
  editingSavedMealHint:
    'Gespeicherte Mahlzeit bearbeiten — Foto hinzufügen oder per Chat korrigieren.',
...
const AR: FoodLogUiCopy = {
  ...
  yourMeal: 'وجبتكم',
  editingSavedMealHint: 'تعديل وجبة محفوظة — أضيفوا صورة أو صحّحوا في الدردشة.',
...
const RU: FoodLogUiCopy = {
  ...
  yourMeal: 'Ваш приём',
  editingSavedMealHint:
    'Правим сохранённый приём — добавьте фото или исправьте в чате.',
...
const PT: FoodLogUiCopy = {
  ...
  editingSavedMealHint:
    'Editando refeição salva — adicione uma foto ou corrija pelo chat.',
...
const IT: FoodLogUiCopy = {
  ...
  editingSavedMealHint:
    'Modifica di un pasto salvato — aggiungi una foto o correggi in chat.',
...
const TR: FoodLogUiCopy = {
  ...
  yourMeal: 'Öğününüz',
  editingSavedMealHint:
    'Kayıtlı öğünü düzenliyorsunuz — foto ekleyin veya sohbetten düzeltin.',
