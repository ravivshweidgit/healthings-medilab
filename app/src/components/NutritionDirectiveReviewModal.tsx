...
const makeStyles = (c: ThemeColors, isDark: boolean) =>
  ...
  error: { fontSize: 13, color: isDark ? c.accentRed : '#E53935', textAlign: 'center' },
  pickBtn: {
  ...
  pickBtnText: { color: isDark ? c.accentBlue : '#fff', fontWeight: '700', fontSize: 15 },
  scroll: { flex: 1 },
  ...
  saveBtnText: { color: isDark ? c.accentBlue : '#fff', fontWeight: '700', fontSize: 16 },
});
