...
**prompt42 follow-up (2026-06-28)** — Weigh-in macro review: remove manual lock from auto-apply block, Gemini retry, My Macros Accept UI instead of dead-end alert. Phone-tested. See `done/prompt42.txt` § Follow-up 2026-06-28 (`ac69355`).
