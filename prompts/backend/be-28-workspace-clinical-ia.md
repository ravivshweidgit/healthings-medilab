...
**Authored by:** Opus 5 (owner walkthrough of all 8 workspace tabs, 2026-07-27)
...
| # | Finding | Evidence |
|---|---|---|
| **P1** | Patient-voice labels shown to clinicians: My Profile / My Targets / My Mentors / My Rules / My Macros | `clinic-workspace.js:556-641`; screenshot 2 |
...
| **P7** | Dashboard offers 1H/2H/3H/6H/12H/24H ranges — CGM-watching behaviour, not case review | screenshot 1 |
...
| **P11** | Inline styles emitted from JS (`style="margin:0 0 16px"`) | `clinic-workspace.js:402, 594, 637, 1077` |

## Scope — this batch

**P1, P2, P3, P5, P6, P7, P10, P11.**
...
Default set becomes **24H · 7D · 30D · 90D**, defaulting to 7D. Keep the sub-day chips
behind a "detail" affordance only if the CGM series is present; a clinician zooming to
2H is doing something the phone is better at.
...
- `website/clinic/clinic-workspace.css` — remove per-tab caps, add grid + banner
