...
| `be-34-billing-live-psp.md` | Stripe Checkout + grace/pause-coverage (dark until flag) | 2026-07-28 — owner: Add card → Stripe not configured; commit after dark deploy |
