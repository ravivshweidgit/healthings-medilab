...
| `be-12-help.md` | Help site (10 locales) | **run next** | Index regression, language switcher, meta/SEO, RTL. Generator only — never hand-edit generated HTML. Note: be-11 already unified `?v=20260726be11` via `CSS_VER`, and `a` now defaults to `--accent-ink` site-wide |
