...
| `be-45-clinic-live-macro-bounds.md` | Clinic live macros — **Save rules builds engine**; Macros · Live = result; constant/%, training add-back, markers % | in_progress | Branch `macro-redesign`. Phase 1 server core started. Then portal → propose auto-apply → prompt114 |
