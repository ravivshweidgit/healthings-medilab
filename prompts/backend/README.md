...
| `be-45-clinic-live-macro-bounds.md` | Clinic live macros — **Save rules builds engine**; Macros · Live = result; constant/%, training add-back, markers % | in_progress | Branch `macro-redesign`. Phases 1–3 on branch (API + portal tab + rules auto-apply). Next: markers UI %, phone prompt114 |
